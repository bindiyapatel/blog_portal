...
<div class="container-fluid" id="loginForm">
   <div class="row">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
            <h2 class="text-center text-success"><strong>  Login </strong> </h2>
            ...
            <div class="form-group">
               <button type="button" class="btn btn-success" id="btnLogin" name="btnLogin">Login</button>
            </div>
            <h4 class="text-center"> if you don't have account then? <a  class="text" href="register.php"> Register </a> </h4>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"></div>
    </div>
</div>
